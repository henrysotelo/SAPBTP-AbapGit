CLASS zcl_load_data_8712 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_load_data_8712 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      lt_ztb_acc_categ TYPE TABLE OF ztb_acc_categ_12,
      lt_ztb_catego    TYPE TABLE OF ztb_catego_12,
      lt_ztb_clientes  TYPE TABLE OF ztb_clientes_12,
      lt_ztb_clnts_lib TYPE TABLE OF ztb_clnts_lib_12,
      lt_ztb_libros    TYPE TABLE OF ztb_libros_12.
    ...
    DELETE FROM ztb_acc_categ_12.
    INSERT ztb_acc_categ_12 FROM TABLE @lt_ztb_acc_categ.

    out->write( sy-dbcnt ).
    out->write( 'ztb_acc_categ_12 data inserted  successfully').
    ...
    DELETE FROM ztb_catego_12.
    INSERT ztb_catego_12 FROM TABLE @lt_ztb_catego.
    out->write( sy-dbcnt ).
    out->write( 'ztb_catego_12 data inserted  successfully').
    ...
    DELETE FROM ztb_clientes_12.
    INSERT ztb_clientes_12 FROM TABLE @lt_ztb_clientes.
    out->write( sy-dbcnt ).
    out->write( 'ztb_clientes_12 data inserted  successfully').
    ...
    lt_ztb_libros
          = VALUE #(
            ( id_libro = '000001'
                    bi_categ     = 'A'
                    titulo       = 'Diccionario de los sentimientos'
                    autor        = 'CAGIGAL, Jose Maria'
                    editorial    = 'ANAGRAMA'
                    idioma       = 'S'
                    paginas      = 350
                    precio       = '84.99'
            ...
            ( id_libro = '000028'
                bi_categ = 'E'
                titulo = 'La historia de los Andes'
                autor = 'Hoagland , M.'
                editorial = 'LATERZ A'
                idioma = 'S'
                paginas = 486
            ...
            ( id_libro = '000003'
                bi_categ = 'A'
                titulo = 'Ética Para Náufragos'
                autor = 'Vallejo- Nágera, Juan'
                editorial = 'LA SOCIAL'
                idioma = 'S'
                paginas = 236
                precio = 35
            ...
            ( id_libro = '000007'
                bi_categ = 'B'
                titulo = 'Your Growing Child and Religion'
                autor = 'Luka Brajnovic'
                editorial = 'KELVIN BOOKS'
                idioma = 'E'
                paginas = 380
                precio = '65.49'
                moneda = 'USD'
            ...
            ( id_libro = '000008'
                bi_categ = 'B'
                titulo = 'Carta a la Familias'
                autor = 'Sastre, José Luis'
                editorial = 'PPC'
                idioma = 'S'
                paginas = 265 precio = '19.99'
                moneda = 'USD'
                formato = 'E'
                url = 'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el- proceso-de-edici%C3%B3n.jpg' )
            ( id_libro = '000009'
                bi_categ = 'C'
                titulo = 'The language of science O'
                autor = 'MANIQUE, John'
                editorial = 'SALVAR EDICION'
                idioma = 'E'
                paginas = 125
                precio = '14.99'
                moneda = 'USD'
            ...
            ( id_libro = '000012'
                bi_categ = 'D'
                titulo = 'Algebra Matricial'
                autor = 'Jose manuel Gamboa'
                editorial = 'Anaya'
                idioma = 'S'
                paginas = 160
                precio = '8.85'
            ...
            ( id_libro = '000014'
                bi_categ = 'E'
                titulo = 'Un pequeño pasa para un hombre'
            ...
            ( id_libro = '000017'
                bi_categ = 'F'
                titulo = 'La popularización del deporte'
                autor = 'García Ferrando, Manuel'
                editorial = 'Centro de Investig.'
                idioma = 'S'
                paginas = 180
                precio = 19
                moneda = 'EUR'
            ...
            ( id_libro = '000018'
                bi_categ = 'F'
                titulo = 'Ideal democrático y bienestar personal'
                autor = 'Llopis Goig, Ramón'
                editorial = 'Centro de Investig.'
                idioma = 'S'
                paginas = 268
                precio = '9.5'
            ...
            ( id_libro = '000019'
                bi_categ = 'F'
                titulo = '14 canciones. El viaje del elefante'
                autor = 'Pastor, Luis'
                editorial = 'El Ángel Caído'
                idioma = 'S'
                paginas = 48
                precio = 21
                moneda = 'USD'
            ...
            ( id_libro = '000021'
                bi_categ = 'F'
                titulo = 'A mil besos. Canciones y poemas'
                autor = 'Cohen, Leonard'
            ...
            ( id_libro = '000022'
                bi_categ = 'G'
                titulo = 'Nada tan amargo: Seis poetas Inglesas'
                autor = 'VV.A.A.'
            ...
            ( id_libro = '000024'
                bi_categ = 'H'
                titulo = 'Atlas de los exploradores'
                autor = 'VV.A.A.'
                editorial = 'PLANETA'
                idioma = 'S'
                paginas = 320
            ...
            ( id_libro = '000026'
                bi_categ = 'H'
                titulo = 'Historia Latinoamericana 1700-2005'
    ...
    DELETE FROM ztb_libros_12.
    INSERT ztb_libros_12 FROM TABLE @lt_ztb_libros.
    out->write( sy-dbcnt ).
    out->write( 'ztb_libros_12 data inserted  successfully').
    ...
    DELETE FROM ztb_clnts_lib_12.
    INSERT ztb_clnts_lib_12 FROM TABLE @lt_ztb_clnts_lib.
    out->write( sy-dbcnt ).
    out->write( 'ztb_clnts_lib_12 data inserted  successfully').
    out->write(  'DONE!' ).
